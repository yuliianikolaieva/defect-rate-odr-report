...
## Ключові цифри (вікно 22 черв — 7 вер 2026)
| Метрика | Значення |
|---|---|
| UA Stores ODR (сер. 12 тижнів) | 19.7% |
| ODR останній тиждень (7 вер) | 21.8% |
| Order replacement rate | 21.0% |
| Частка quantity у дефектах | 65.4% |
| VARUS ODR | 56.6% (останній тиждень 63.8%) |
...
## Порівняння країн (22 черв — 7 вер 2026, однакове визначення ODR)
| Країна | ODR ринку | Сер. ODR топ-5 | Без 1P |
|---|---|---|---|
| Румунія | 38.0% | 40.4% | 50.4% |
| Естонія | 13.8% | 14.1% | 17.4% |
| Литва | 24.8% | 20.2% | 25.2% |
| **Україна** | **19.7%** | **19.9%** | **19.9%** |
